...
import { useImageLoad } from "@/hooks/text-editor/use-image-load";
import { cn } from "@/lib/utils";
import { ElementDimensions, useImageResize } from "@/hooks/text-editor/use-image-resize";
import { NodeSelection } from "@tiptap/pm/state";
import { useImageActions } from "@/hooks/text-editor/use-image-actions";
import { blobUrlToBase64 } from "@/lib/tiptap-utils";
import { LoaderCircleIcon, TrashIcon } from "lucide-react";
import { InfoCircledIcon } from "@radix-ui/react-icons";
import { ResizeHandle } from "./handle-resize";
