  ...
  return (
    <section className="relative min-h-screen  grid place-items-center overflow-hidden">
      ...
      <Image
        ...
        alt="Doctor Hero"
        className="object-cover w-full h-full absolute object-bottom"
        width={1920}
        height={1080}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-8 py-12">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <p className="max-w-[600px] text-secondary md:text-xl">
              Konsultasi dengan dokter terpercaya, beli obat, dan buat janji
              temu kapan saja dan dimana saja.
            </p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Link href="/doctor/dashboard/questions">
              <Card className="opacity-70 hover:opacity-100 transition-opacity">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Dapatkan saran medis dari dokter terpercaya kapan saja dan
                    di mana saja.
                  </p>
                </CardContent>
              </Card>
            ...
            <Link className="md:col-span-2" href={"/doctor/dashboard/appointments"}>
              <Card className=" opacity-70 hover:opacity-100 transition-opacity">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Atur jadwal kunjungan ke dokter atau rumah sakit dengan
                    mudah dan cepat.
                  </p>
                </CardContent>
              </Card>
